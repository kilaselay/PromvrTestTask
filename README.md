...
через функции `Load`/`Store` и вычислением шага буффера в байтах. Кроме отсутствия затрат на выделение памяти еще и получится прирост в производительности.
...
Либо вне HDRP вручную написать кастомный шейдер с тесселяцией. Так дополнительно получим прибавку в скорости работы.
